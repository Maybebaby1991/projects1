...
while delay_XUV < delay_XUV_max:
	...
	# str_param = "Recalc_" + "UncellArea_" + "_Nk_" + str(Nk)  + "intens_" + '{:.2e}'.format(intens)+ "_t1_" +str(t1) + "_Ncut" +str(Ncut) + "_qTF_" + str(qTF) + "_dt_" + str(dt)+"_delayXUV_" + str(delay_XUV) + "w_Pump_" + "R0-" + str(gleb)+ "EPS-" + str(eps)
